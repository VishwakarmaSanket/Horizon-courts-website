...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-[#0A1D2A] to-[#081625] text-white p-8 lg:p-16 rounded-[3rem] mt-16 shadow-2xl">
      {/* Top Section */}
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
        ...
        <div className="flex flex-col gap-6">
          <p className="text-sm font-semibold text-[#B7C6D1] uppercase tracking-widest">Follow us</p>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-16">
        ...
        <div className="flex flex-col sm:flex-row gap-12 lg:gap-24 text-sm">
          <div className="flex flex-col gap-4">
            <p className="text-[#9FB0BD] font-semibold uppercase tracking-wider mb-2">About</p>
            <p className="cursor-pointer hover:text-[#3BB2FF] transition-colors">Services</p>
            <p className="cursor-pointer hover:text-[#3BB2FF] transition-colors">Coaches</p>
            <p className="cursor-pointer hover:text-[#3BB2FF] transition-colors">Events</p>
            <p className="cursor-pointer hover:text-[#3BB2FF] transition-colors">Membership</p>
          </div>

          <div className="flex flex-col gap-4 text-[#E6EFF5]">
            <p className="text-[#9FB0BD] font-semibold uppercase tracking-wider mb-2">Contact</p>
            <p className="leading-relaxed">
              123 Pacific Drive, Santa Monica, CA 90401
            </p>
            <p>Open daily: 7:00 AM – 10:00 PM</p>
            <p className="font-semibold text-lg text-[#3BB2FF]">(310) 555-7890</p>
          </div>
        </div>
      </div>
